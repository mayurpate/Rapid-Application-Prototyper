...
grails.hibernate.cache.queries = false
  ...
  grails.config.locations = [
      "file:${userHome}/rapper-config.groovy"
      ]
...
environments {
    development {
     ...
     //grails.serverURL = "http://192.168.2.10:8080/rapper"
    }
    production {
...
grails.plugins.springsecurity.successHandler.defaultTargetUrl = '/PageDetails/showAllProjects'
